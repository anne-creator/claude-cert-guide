...
flowchart TD
    A([🚀 开始]) --> B{"你在中国大陆？"}
    B -->|是| C["⚠️ 考试报名目前不确定能否参加<br/>建议先专注拿各门课 certificate"]
    B -->|否| D{"你的目标是？"}
    C --> E
    D -->|"深入学习 Learn deeply"| E["📚 优先完成四门课<br/>课程价值 > study guide > practice exam<br/>每门修完有独立 certificate 可分享"]
    D -->|"尽快通过考试 Pass ASAP"| F{"你的技术背景？"}
    F -->|"工程师<br/>Engineer"| G["🏃 2 天 / 一个周末<br/>按策略刷 practice exam 即可"]
    F -->|"开发者 Developer<br/>但无 AI Agent 经验"| H["📅 2–4 天<br/>课程 + practice exam 结合"]
    F -->|"非开发者<br/>Non-developer"| I["🌱 至少一周<br/>建议调整目标 ↓"]
...
- **考试方式**：不需要预约，在线直接考
- **备考资料**（在本 repo 内直接下载）：
  - [Study Guide](./Study-Guide.pdf) — 考试范围概览，配合 practice exam 用
  - [FAQ](./FAQ.pdf) — 常见问题汇总
...
<div align="center">
  <img src="a960d21ff4a8eb4297709b6f3f65b1fd.jpg" width="320" alt="小红书 - Anne" />
  <br/><br/>
